#
#  Be sure to run `pod spec lint AlgorithmsAndDataStructures.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Sebastian Tleye"
  # spec.authors            = { "Sebastian Tleye" => "stleye@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Sebastian Tleye"
